...
const $sliderSection = document.querySelectorAll("[data-slider-section]");
...
for (const [index, $sliderSection] of $sliderSection.entries())
 {
    ...
    <div class="container">          
        ...
        <div class="slider">
            ...
            ${`<li class="slider-items>${$skeletonCard}</li>`.repeat(10)}
            </ul>
            </div>
    </div>
    `;

const $sliderWrapper = $sliderSection.querySelector(["data-slider-warpper"]);
